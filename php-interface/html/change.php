...
if (isset($_REQUEST['initPeruse']) and ($_REQUEST['initPeruse'] != '') and isset($_REQUEST['port']) and ($_REQUEST['port'] != '')) { 
    ...
    $nodeServerPath = 'node '.$NODE_HOME.'/asherat666-peruse-a-rue/bin/peruse-a-rue';
    $controllerPath = $NODE_HOME.'/asherat666-peruse-a-rue/spacenav-emitter /dev/input/spacenavigator 127.0.0.1 8086';
